...
#[derive(Serialize)]
pub struct ActixHealthResponse {
    status: String,
    message: String,
}
...
async fn health_actix() -> impl Responder {
    HttpResponse::Ok().json(ActixHealthResponse {
        status: "ok".to_string(),
        message: "Actix server is running".to_string(),
    })
}
        ...
        App::new()
            ...
            .service(
                web::scope("/api")
                    ...
                    .route("/health", web::get().to(health_actix))
